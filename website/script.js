...
const CE_ENTRIES = [
  {
    ...
    title: '<span class="lang-en">From media to politics</span><span class="lang-zh">從傳媒轉戰政界</span>',
    body: '<span class="lang-en">Ritch was the first to register as a candidate for Ward 2, launching his campaign with a focus on traffic safety, budget management, and more recreational and green space for the community.</span><span class="lang-zh">劉肇麟成為第二選區首位登記參選人，競選重點包括交通安全、財政管理，以及增加社區康樂及綠化空間。</span>',
  ...
  },
  {
    ...
    title: '<span class="lang-en">Elected Ward 2 Councillor</span><span class="lang-zh">當選第二區市議員</span>',
    body: '<span class="lang-en">Wins the 2022 Municipal Election with 3,012 votes, becoming Councillor for Ward 2 and beginning direct constituent work across Civic Centre, Buttonville, Cachet, Cathedraltown, Victoria Square, and Springwater.</span><span class="lang-zh">在2022年市政選舉中以3,012票當選，成為第二區市議員，開始為Civic Centre、Buttonville、Cachet、Cathedraltown、Victoria Square及Springwater的居民直接服務。</span>',
  ...
  },
  {
    ...
    label: '<span class="lang-en">Founding member, A.C.E.</span><span class="lang-zh">A.C.E.政經民社創會成員、前會長</span>',
    title: '<span class="lang-en">Founding member, Active Community Engagement (A.C.E.)</span><span class="lang-zh">Active Community Engagement（A.C.E.）政經民社創會成員、前會長</span>',
    body: '<span class="lang-en">As former President and a founding member of Active Community Engagement (A.C.E.), Ritch helped organize community initiatives such as rapid test kit giveaways for residents.</span><span class="lang-zh">劉肇麟為政經民社 Active Community Engagement（A.C.E.）前任會長及創會成員，曾協助組織社區活動，包括為居民派發快速測試套裝。</span>',
  ...
  },
  {
    ...
    body: '<span class="lang-en">Ritch serves as an Honorary Advisor to Cherish Integrated Services, supporting their specialized work for people with intellectual disabilities in the community.</span><span class="lang-zh">劉肇麟擔任Cherish Integrated Services智愛中心榮譽顧問，支持其對智力障礙群體的社區服務工作。</span>',
  ...
  },
  {
    ...
    label: '<span class="lang-en">Traffic safety push</span><span class="lang-zh">爭取社區及交通安全</span>',
    title: '<span class="lang-en">Working on traffic safety</span><span class="lang-zh">推動社區及交通安全</span>',
    body: '<span class="lang-en">As a young father himself, Ritch made community and traffic safety a priority, working with community groups and York Regional Police to make Ward 2 streets safer for families.</span><span class="lang-zh">身為年輕父親，劉肇麟將社區及交通安全列為首要工作，與社區組織及約克區警察合作，致力令第二區的街道及家庭更安全。</span>',
  ...
  },
  {
    ...
    title: '<span class="lang-en">Pushing for a future multi-purpose Community Centre</span><span class="lang-zh">全新多用途社區中心議案在市議會獲通過</span>',
    body: '<span class="lang-en">Councillor Lau brought forward and successfully passed a motion addressing Ward 2’s long-standing need for its own dedicated community centre. The motion highlighted the growing demand for sports and recreational programs, where available spaces continue to fall short of residents’ needs. It received unanimous support from the Mayor, Deputy Mayor, and all Members of Markham City Council, marking an important step toward securing a future multi-purpose community centre for Ward 2..</span><span class="lang-zh">2024年11月，劉議員提出並成功推動個人議案，反映第二區居民多年來缺乏專屬社區中心的現況，以及體育及康樂活動名額長期供不應求的需求。議案最終獲得市長、副市長及全體萬錦市議員一致支持通過，為爭取第二區未來多用途社區中心邁出重要一步。</span>',
